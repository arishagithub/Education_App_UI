        ...
        children: [
          Container(
            ...
            child: Center(
              child: Container(
                ...
                child: Icon(Icons.play_arrow_rounded,color: Colors.teal,size: 45,),
              ),
            )
          ),
          SizedBox(height: 15,),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Material(
                  color:isVideoSection ? Colors.teal: Colors.teal.withOpacity(0.6),
                  borderRadius: BorderRadius.circular(10),
                  child: InkWell(
                    onTap: (){
                      setState(() {
                ...
                Material(
                  color:isVideoSection ? Colors.teal.withOpacity(0.6): Colors.teal ,
                  borderRadius: BorderRadius.circular(10),
                  child: InkWell(
                    onTap: (){
                      setState(() {
